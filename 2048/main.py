...
class GameRunner:
    ...
    def print_matrix(self):
        ...
        for i in range(0, self.game.board_size):
            for j in range(0, self.game.board_size):
                ...
                self.draw_label_hl(tile_lbl_pos, tile_lbl,
                                   2, [230] * 3, 1, False)
    ...
    def print_game_over(self):
        ...
        score_lbl = self.getScoreLabel()
        restart_lbl = self.myfont.render(
            "Press r to restart!", 1, BLACK, WHITE)
...
parser.add_argument('--test', '-t', dest="test", type=int,
                    default=0, help='0: initializes game, 1: autograde')
...
if __name__ == '__main__':
    if args.test == 1:
        ...
        ROTATIONS = {pygame.K_UP: 0, pygame.K_DOWN: 2,
